        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl">
              Invoice faster, get paid
              <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                sooner with InvoiceFlow
              </span>
            </h1>

            {/* Description */}
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Streamline your invoicing and accounting with automated workflows, real-time payment
              tracking, and seamless integrations. Built for small businesses and freelancers who
              value their time.
            </p>
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-card shadow-2xl">
              <div className="aspect-[16/10] relative">
                <Image
                  ...
                  alt="InvoiceFlow dashboard showing invoice management and payment tracking"
                  fill
